...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HMSSDK",
            url: "https://github.com/100mslive/100ms-ios-sdk/releases/download/0.9.5/HMSSDK.xcframework.zip",
            checksum: "758aca2e4a173ee1f0cced930c81214e3cf85b4357fda14de344f9c38995ee2a"
        ),
        .binaryTarget(
            name: "WebRTC",
