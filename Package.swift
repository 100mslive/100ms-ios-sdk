...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HMSSDK",
            url: "https://github.com/100mslive/100ms-ios-sdk/releases/download/0.4.2/HMSSDK.xcframework.zip",
            checksum: "f12b64380e6f54cd8c1f0e30ac540f6a5f699dd7739523c70f7039edfa6dc03b"
        ),
        .binaryTarget(
            name: "WebRTC",
