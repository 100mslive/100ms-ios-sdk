...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HMSSDK",
            url: "https://github.com/100mslive/100ms-ios-sdk/releases/download/0.9.8/HMSSDK.xcframework.zip",
            checksum: "196f5813a98cf82eb680e4a835e783ed275a41f03f67a1cc0d25393f06aacf95"
        ),
        .binaryTarget(
            name: "WebRTC",
