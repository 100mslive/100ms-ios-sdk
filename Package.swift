...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HMSSDK",
            url: "https://github.com/100mslive/100ms-ios-sdk/releases/download/0.1.1/HMSSDK.xcframework.zip",
            checksum: "4d497afe394ce05bb7eb30824a75ab7fd7d2c8da8e4cbe476337b9ef3cec366a"
        ),
        .binaryTarget(
            name: "WebRTC",
