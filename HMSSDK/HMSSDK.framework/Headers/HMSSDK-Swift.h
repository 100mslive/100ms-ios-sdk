...
- (nonnull instancetype)initWithUserName:(NSString * _Nonnull)userName userID:(NSString * _Nonnull)userID roomID:(NSString * _Nonnull)roomID authToken:(NSString * _Nonnull)authToken joiningMode:(enum HMSMode)joiningMode shouldSkipPIIEvents:(BOOL)shouldSkipPIIEvents metaData:(NSString * _Nullable)metaData endpoint:(NSString * _Nullable)endpoint OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, strong) HMSRole * _Nonnull role;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (void)logMessage:(NSString * _Nonnull)message level:(HMSLogLevel)level;
@end
...
typedef SWIFT_ENUM(NSInteger, HMSMode, open) {
  HMSModePublishAndSubscribe = 0,
  HMSModeOnlySubscribe = 1,
  HMSModeOnlyPublish = 2,
  HMSModeAuto = 3,
};
...
@property (nonatomic, copy) NSString * _Nonnull name;
@property (nonatomic) enum HMSMode mode;
...
@property (nonatomic) HMSLogLevel logLevel;
